...
<title>115网盘签到领空间助手</title>
</head>
<body>
<div class="title">115网盘签到领空间助手 [ <a href="javascript:history.back();">返回</a> ]</div>
<div class="content"><form action='do.php' method='GET'>
登录你的115网盘账户：<br/>用户名:<br/>
...
网络任务执行频率一天1～2次即可，过于频繁地登录会导致115网盘登录出现验证码而签到失败。</div>
